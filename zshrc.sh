...
function update_current_git_vars() {
	...
	GIT_REMOTE_BRANCH=$__CURRENT_GIT_STATUS[2]
	GIT_REMOTE=$__CURRENT_GIT_STATUS[3]
	GIT_AHEAD=$__CURRENT_GIT_STATUS[4]
	GIT_BEHIND=$__CURRENT_GIT_STATUS[5]
	GIT_STAGED=$__CURRENT_GIT_STATUS[6]
	GIT_CONFLICTS=$__CURRENT_GIT_STATUS[7]
	GIT_CHANGED=$__CURRENT_GIT_STATUS[8]
	GIT_UNTRACKED=$__CURRENT_GIT_STATUS[9]
	GIT_STASHED=$__CURRENT_GIT_STATUS[10]
}
